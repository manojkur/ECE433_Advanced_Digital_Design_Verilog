...
xst -ifn xst.scr
move ClockUnit50MHz_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\ClockUnit50MHz_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc ClockUnit50MHz_exdes.ucf ClockUnit50MHz_exdes

echo 'Running map'
map -timing -pr b ClockUnit50MHz_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm ClockUnit50MHz_exdes -w routed.ncd routed.v
cd ..
