...
#endif
static const char *ng0 = "D:/My Files/Classwork/3-Junior/1-Fall Quarter/ECE433/git/New folder/ECE433_Advanced_Digital_Design_Verilog/PG/PongGamePhase2/SourceFiles/CRTcontrollerr2018fall_tb.v";
static int ng1[] = {8, 0};
static int ng2[] = {4, 0};
static int ng3[] = {6, 0};
static int ng4[] = {2, 0};
