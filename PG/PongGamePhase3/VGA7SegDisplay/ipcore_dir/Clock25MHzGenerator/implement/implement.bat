...
xst -ifn xst.scr
move Clock25MHzGenerator_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\Clock25MHzGenerator_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc Clock25MHzGenerator_exdes.ucf Clock25MHzGenerator_exdes

echo 'Running map'
map -timing -pr b Clock25MHzGenerator_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm Clock25MHzGenerator_exdes -w routed.ncd routed.v
cd ..
